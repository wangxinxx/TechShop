...
@NgModule({
    imports: [
        RouterModule.forChild([
            ...
            {
                path: 'region',
                loadChildren: './region/region.module#TechShopRegionModule'
            },
            {
                path: 'city',
                loadChildren: './city/city.module#TechShopCityModule'
            ...
            {
                path: 'address',
                loadChildren: './address/address.module#TechShopAddressModule'
            },
            {
                path: 'address',
                loadChildren: './address/address.module#TechShopAddressModule'
            ...
            {
                path: 'manufacturer',
                loadChildren: './manufacturer/manufacturer.module#TechShopManufacturerModule'
            },
            {
                path: 'item',
                loadChildren: './item/item.module#TechShopItemModule'
