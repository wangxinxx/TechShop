...
import { IPassport, Passport } from 'app/shared/model/passport.model';
...
describe('Service Tests', () => {
    describe('Passport Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(PassportService);
            httpMock = injector.get(HttpTestingController);
            currentDate = moment();

            elemDefault = new Passport(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', currentDate, 'AAAAAAA', 'AAAAAAA', false);
        });
